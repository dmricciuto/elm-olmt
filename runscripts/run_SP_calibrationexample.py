...
exeroot = '/lcrc/group/e3sm/ac.ricciuto/scratch/e3sm_run/20250411_US-MOz_ICB1850CNRDCTCBC_ad_spinup/bld/'
...
nyears_final   =  45      #number of years for final spinup OR for SP run
...
parm_list      = '/lcrc/group/e3sm/ac.ricciuto/elm-olmt/parm_list_example'  #'parm_list_example' #Set parameter list (leave blank for no ensemble)
nsamples       =  512    #number of samples to run
...
#  length of the postprocessed record (in this case, annual data from 2007 to 2011)
#This could be replaced with code to read an observation file.
observations = {}
observations['GPP'] =  np.array([4.0, 4.0, 4.0, 4.0, 4.0]) #umol m-2 s-1
observations['EFLX_LH_TOT'] = np.array([50,50,50,50,50])
observation_error = {}
observation_error['GPP'] = observations['GPP']*0.05
observation_error['EFLX_LH_TOT'] = observations['EFLX_LH_TOT']*0.05
